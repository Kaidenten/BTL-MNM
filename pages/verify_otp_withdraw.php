<?php
$pageTitle = 'Xác nhận OTP rút tiền';
  ...
  <div class="row justify-content-center">
    <div class="col-lg-5">
      ...
      <div class="d-flex align-items-center gap-3 mb-4">
        <a href="/BTL-MNM/pages/withdraw.php" class="btn btn-light btn-sm"><i class="bi bi-arrow-left"></i></a>
        <div>
          <h5 class="mb-0 fw-bold">Xác nhận OTP</h5>
          <small class="text-muted">Xác nhận rút tiền về ngân hàng</small>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-body p-4">
          <h6 class="fw-bold mb-3"><i class="bi bi-info-circle me-2 text-danger"></i>Thông tin rút tiền</h6>
          <table class="table table-borderless small mb-0">
            ...
            <tr><td class="text-muted fw-semibold">Số tiền rút</td>              <td class="fw-bold text-danger fs-5">-<?= formatMoney($pending['amount']) ?></td></tr>
          </table>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
          ...
          <form action="/BTL-MNM/api/verify_otp_withdraw.php" method="POST">
            <div class="mb-4">
          ...
          <div class="text-center mt-3">
            <a href="/BTL-MNM/pages/withdraw.php" class="small text-muted">
