      ...
      <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-muted small"><?= htmlspecialchars($tx['message']) ?></td>
            ...
            <td class="text-muted small">
              <?php if ($tx['type'] === 'transfer'): ?>
                <?= $tx['sender_name'] === ($_SESSION['full_name'] ?? '')
                    ? 'Đến: ' . htmlspecialchars($tx['receiver_name'])
                    : 'Từ: '  . htmlspecialchars($tx['sender_name']) ?>
              <?php else: ?>
                —
              <?php endif; ?>
            </td>
